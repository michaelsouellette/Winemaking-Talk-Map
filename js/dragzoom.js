...
DragZoomControl.prototype.initButton_ = function(buttonContainerDiv) {
  ...
  DragZoomUtil.style([buttonDiv], {cursor: 'pointer', zIndex:88});
...
DragZoomControl.prototype.initBackButton_ = function(buttonContainerDiv) {
  ...
  DragZoomUtil.style([backButtonDiv], {cursor: 'pointer', zIndex:88});
...
DragZoomControl.prototype.initialize = function(map) {
  ...
  DragZoomUtil.style([buttonContainerDiv], {cursor: 'pointer', zIndex: 85});
  ...
  DragZoomUtil.style([zoomDiv], {position: 'absolute', display: 'none', overflow: 'hidden', cursor: 'crosshair', zIndex: 81});
...
DragZoomControl.prototype.getDefaultPosition = function() {
  return new GControlPosition(G_ANCHOR_TOP_LEFT, new GSize(75, 23));
};
