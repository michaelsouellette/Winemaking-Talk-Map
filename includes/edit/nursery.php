...
echo '	
		...
		//<dl>
		//	<dt><label for="produce">Produce Available:<input type="hidden" class="DEPENDS ON option BEING o1"></label></dt>
		//	<dd><textarea class="DEPENDS ON option BEING o1" name="produce" id="produce" rows="4" style="solid; margin-right: 5px; margin-top: 4px; width: 200px;">',$produce,'</textarea></dd>
		//</dl>
		echo '
		</fieldset>
